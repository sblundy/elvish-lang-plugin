...
public class ElvishSetLValueImpl extends ElvishVariableAssignmentImpl implements ElvishSetLValue {

  public ElvishSetLValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ElvishVisitor visitor) {
    visitor.visitSetLValue(this);
  }
