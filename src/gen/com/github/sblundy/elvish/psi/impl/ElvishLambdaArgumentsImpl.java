...
public class ElvishLambdaArgumentsImpl extends ASTWrapperPsiElement implements ElvishLambdaArguments {

  public ElvishLambdaArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
