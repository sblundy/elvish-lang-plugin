...
public class ElvishNamespaceNameImpl extends ElvishNamespaceIdentifierImpl implements ElvishNamespaceName {

  public ElvishNamespaceNameImpl(@NotNull ASTNode node) {
    super(node);
  }
