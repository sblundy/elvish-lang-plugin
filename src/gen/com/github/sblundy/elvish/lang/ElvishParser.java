...
public class ElvishParser implements PsiParser, LightPsiParser {
  ...
  static boolean AllSpecialCommand(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "AllSpecialCommand")) return false;
    boolean result_;
  ...
  // (LocalNamespace | EnvVarNamespace)?
  private static boolean DeleteCommand_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "DeleteCommand_2")) return false;
    DeleteCommand_2_0(builder_, level_ + 1);
    return true;
  }

  // LocalNamespace | EnvVarNamespace
  private static boolean DeleteCommand_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "DeleteCommand_2_0")) return false;
    boolean result_;
    result_ = LocalNamespace(builder_, level_ + 1);
    if (!result_) result_ = EnvVarNamespace(builder_, level_ + 1);
    return result_;
  }

  // VarIndex*
  private static boolean DeleteCommand_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "DeleteCommand_4")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!VarIndex(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "DeleteCommand_4", pos_)) break;
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // &ExplicitVariableDeclarationAndSetFlag KEYWORD_SET (Space+ SetLValues)+ (Space+|<<missingSpaceInVarOrSet>>) EQUALS (Space+|<<missingSpaceInVarOrSet>>) Compound (Space+ Compound)*
  ...
  private static boolean SetCommand_3(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = SetCommand_3_0(builder_, level_ + 1);
    if (!result_) result_ = missingSpaceInVarOrSet(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // Space+
  private static boolean SetCommand_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "SetCommand_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = Space(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!Space(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "SetCommand_3_0", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean SetCommand_5(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = SetCommand_5_0(builder_, level_ + 1);
    if (!result_) result_ = missingSpaceInVarOrSet(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // Space+
  private static boolean SetCommand_5_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "SetCommand_5_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = Space(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!Space(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "SetCommand_5_0", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // &ExplicitVariableDeclarationAndSetFlag KEYWORD_VAR (Space+ VarLValue)+ ((Space+|<<missingSpaceInVarOrSet>>) EQUALS (Space+|<<missingSpaceInVarOrSet>>) Compound (Space+ Compound)*)?
  ...
  // ((Space+|<<missingSpaceInVarOrSet>>) EQUALS (Space+|<<missingSpaceInVarOrSet>>) Compound (Space+ Compound)*)?
  ...
  private static boolean VarCommand_3_0_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = VarCommand_3_0_0_0(builder_, level_ + 1);
    if (!result_) result_ = missingSpaceInVarOrSet(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // Space+
  private static boolean VarCommand_3_0_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "VarCommand_3_0_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = Space(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!Space(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "VarCommand_3_0_0_0", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean VarCommand_3_0_2(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = VarCommand_3_0_2_0(builder_, level_ + 1);
    if (!result_) result_ = missingSpaceInVarOrSet(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // Space+
  private static boolean VarCommand_3_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "VarCommand_3_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = Space(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!Space(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "VarCommand_3_0_2_0", pos_)) break;
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // OPEN_BRACKET (IndexRange | IndexSingle) (Space (IndexRange | IndexSingle))* CLOSE_BRACKET
  public static boolean VarIndex(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "VarIndex")) return false;
    if (!nextTokenIs(builder_, OPEN_BRACKET)) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, VAR_INDEX, null);
    result_ = consumeToken(builder_, OPEN_BRACKET);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, VarIndex_1(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, VarIndex_2(builder_, level_ + 1)) && result_;
  ...
  private static boolean VarIndex_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "VarIndex_1")) return false;
    boolean result_;
  ...
  // (Space (IndexRange | IndexSingle))*
  private static boolean VarIndex_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "VarIndex_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!VarIndex_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "VarIndex_2", pos_)) break;
    }
    return true;
  }

  // Space (IndexRange | IndexSingle)
  private static boolean VarIndex_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "VarIndex_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = Space(builder_, level_ + 1);
    result_ = result_ && VarIndex_2_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // IndexRange | IndexSingle
  private static boolean VarIndex_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "VarIndex_2_0_1")) return false;
    boolean result_;
    result_ = IndexRange(builder_, level_ + 1);
    if (!result_) result_ = IndexSingle(builder_, level_ + 1);
    return result_;
